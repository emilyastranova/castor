...
!(function () {
	...
	const Qn = (e, t, n) => {
		...
		no = (e, t = !1) => {
			return Yn(e)
				...
				: ((n = e), to(n, '[contenteditable]')).fold(N(t), (e) => 'true' === oo(e));
			var n;
		},
	...
	const jo = (e) => (t) => !!t && t.nodeType === e,
		...
		Vr = (e) => {
			const t = e.container();
			return (
				!!Jo(t) && (t.data.charAt(e.offset()) === Mr || (e.isAtStart() && Hr(t.previousSibling)))
			);
		},
		Wr = (e) => {
			const t = e.container();
			return (
				!!Jo(t) && (t.data.charAt(e.offset() - 1) === Mr || (e.isAtEnd() && Hr(t.nextSibling)))
			);
		},
	...
	const wa = Dt.each,
		...
		Aa = (e, t, n) => {
			...
			y(n) || '' === n
				? fo(e, o)
				: ao(e, o, ((e, t) => (x(e) ? (ke(Ea, t) ? e + '' : e + 'px') : e))(n, o));
		},
		Oa = (e, t = {}) => {
			const n = {},
				o = window,
			...
			const a = Ms.forElement(yn(e), {
				...
				q = (n, r, s, a) => {
					...
					return (
						!t.collect || (n !== e && n !== o) || i.push([n, r, s, a]), c.bind(n, r, s, a || G)
					);
				},
				W = (t, n, r) => {
					if (p(t)) {
					...
					isEmpty: (e, t, n) => {
						...
						if (r) {
							...
							do {
								...
								if (tr(d)) return !1;
								if (Jo(d) && !ds(d.data) && (!(null == n ? void 0 : n.includeZwsp) || !cs(d.data)))
									return !1;
	...
	const ti = (e) => {
		...
		di = (e, t) => (
			(e = li(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e
		),
					...
					(n = ((e) => {
						const t = [],
							...
							o = (e, t) => {
								...
								if (t < e.data.length) {
									...
									if (bi(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !Ti(o)))
										return void n(Pi(Di(o), !1));
								}
								t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), Ti(o) || n(Pi(Di(o), !1))),
									t < e.data.length &&
										(o.setStart(e, t), o.setEnd(e, t + 1), Ti(o) || n(Pi(Di(o), !0)));
							},
							r = e.container(),
							s = e.offset();
						...
						if (vi(r))
							if (e.isAtEnd()) {
								...
								xi(i) && !Si(i) && (Ci(i) || Ci(a) || !xi(a)) && n(Pi(Di(i), !1)),
									xi(a) && n(Pi(Di(a), !0));
							}
						return t;
					})(Li(e, t))),
	...
	const Mi = (e, t) => {
		...
		Hi = (e) =>
			e
				? Te(
						e.childNodes,
						(e, t) => (Ui(t) && 'BR' !== t.nodeName ? (e = e.concat(Hi(t))) : e.push(t), e),
						[]
				  )
				: [],
		$i = (e) => (t) => e === t,
		...
		Vi = (e, t) => {
			...
			return (
				(a = Oe(a, T(Go))), (o = o.concat(Ae(a, (e) => qi(e)))), o.reverse().join('/') + ',' + n
			);
		},
		Wi = (e, t) => {
			if (!t) return null;
				...
				i.push(
					n
						? ((e, t, n) => {
								...
								for (let n = t.previousSibling; n && Jo(n); n = n.previousSibling)
									o += e(n.data).length;
								return o;
						  })(t, s, a)
						: a
	...
	const Zc = ir,
		...
		ou = ss,
		ru = (e) =>
			ns(e) || ((e) => !!as(e) && !X(ce(e.getElementsByTagName('*')), (e, t) => e || Qr(t), !1))(e),
		su = is,
		...
		Nu = (e, t) => (
			$o(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t
		),
		Ru = (e, t) =>
			Cu(e).fold(
				L,
	...
	const Fu = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
		...
		lm = (e, t) => {
			...
			if (
				...
				if (a < i.length) {
					...
					(d = new zo(t, null !== (o = e.getParent(t, e.isBlock)) && void 0 !== o ? o : l)),
						d.next(!0);
				}
		...
		vm = (e, t) => {
			...
			return (
				e.getParent(
					t,
					(t) => !!$o(t) && ((n = e.getStyle(t, 'text-decoration')), !!n && 'none' !== n)
				),
				n
			);
		},
		...
		Pm = (e, t, n, o, r) => {
			...
			for (let o = 0; o < a.length; o++)
				for (let r = 0; r < t.length; r++) {
					const s = t[r];
					if ((!C(s.collapsed) || s.collapsed === n.collapsed) && xm(s) && e.is(a[o], s.selector))
						return a[o];
				}
			return o;
		},
		...
		Im = (e, t, n, o, r) => {
			...
			for (; s; ) {
				...
				for (let t = s[a]; t; t = t[a]) {
					...
					if (
						!Sm(t) &&
						(!rr((l = t)) || !l.getAttribute('data-mce-bogus') || l.nextSibling) &&
						!Nm(t, n)
					)
						return s;
				}
		...
		Um = (e, t, n, o = !1) => {
			...
			return (
				...
				(wm(l) || xm(l)) &&
					...
					wm(l) &&
						(e.isBlock(r) || (r = Im(e, n, r, s, !0)), e.isBlock(a) || (a = Im(e, n, a, i, !1)))),
	...
	const uf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
				...
				return ((e, t) => {
					...
					return n.collapsed
						? t
								...
								.map((e) =>
									df.rtl(yn(e.endContainer), e.endOffset, yn(e.startContainer), e.startOffset)
								)
			...
			((e, t, n) =>
				((e, t, n) => {
					...
					return mf(o, t, n).map((e) =>
						uf(yn(e.startContainer), e.startOffset, yn(e.endContainer), e.endOffset)
					);
		...
		Rf = (e, t, n, o, r) => {
			...
			for (; (d = u[o ? 'prev' : 'next']()); ) {
				...
				if (Jo(d) && d.data.length > 0)
					return Sf(d, s, 'A') ? I.none() : I.some(Li(d, o ? d.data.length : 0));
		...
		Af = (e, t, n, o) => {
			...
			if (
				($o(i) && l > i.childNodes.length - 1 && (u = !1), nr(i) && ((i = r), (l = 0)), i === r)
			) {
	...
	const gg = Oa.DOM,
		...
		hg = (e, t) => {
			const n = gd(e),
				o = gg.getParent(
					t,
					(t) => ((e) => $o(e) && ug.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
				);
			return null !== o;
		},
		bg = (e) => {
		...
		Cg = (e, t) => {
			((e, t) =>
				((e) => (e.collapsed ? I.from(pi(e.startContainer, e.startOffset)).map(yn) : I.none()))(
					t
				).bind((t) => (Rr(t) ? I.some(t) : Sn(e, t) ? I.none() : I.some(e))))(yn(e.getBody()), t)
				.bind((e) => yu(e.dom))
				.fold(
					() => {
			...
			e.inline
				? ((e) => {
						...
						return (
							t &&
							((n = yn(t)),
							tg(n) || ((o = n), ng(qn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
						);
						var n, o;
				  })(e)
	...
	const Ug = (e) =>
			(0 === e.length ? '' : `${q(e, (e) => `[${e}]`).join(',')},`) + '[data-mce-bogus="all"]',
	...
	const Jg = ['font', 'text-decoration', 'text-emphasis'],
		...
		pp = sp(!1, ip),
		hp = (e, t) =>
			((e, t, n) => (Sn(t, e) ? Tn(e, (e) => n(e) || En(e, t)).slice(0, -1) : []))(e, t, L),
		...
		Vp = (e, t, n) => {
			...
			return n || !Hp(o, o.length - 1) || jp(e, r)
				? !!(n && $p(o, o.length - 1) && zp(e, r)) && ((t.data = o.slice(0, -1) + pr), !0)
					...
					((e) => {
						const t = e.data,
							n = ((e) => {
								const t = e.split('');
								return q(t, (e, n) =>
									Mu(e) && n > 0 && n < t.length - 1 && Uu(t[n - 1]) && Uu(t[n + 1]) ? ' ' : e
								).join('');
							})(t);
				...
				e
					? ((e, t) =>
							Zp(t)
								.orThunk(() => Jp(t))
								.orThunk(() =>
									((e, t) => bu(e, Li.after(t)).orThunk(() => vu(e, Li.before(t))))(e, t)
								))(t, n)
					: ((e, t) =>
							Jp(t)
								.orThunk(() => Zp(t))
			...
			const i = ((e, t, n) => {
				...
				return (
					...
					s.isSome() && a.isSome() && i.isSome()
						...
						: I.none()).orThunk(
						() => (n && (o.each((e) => Yp(e.dom, e.dom.length)), r.each((e) => Gp(e.dom, 0))), t)
					)
				);
				var s, a, i, l;
		...
		_h = (e) => (t) =>
			Sh(t, e).map((e) => ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, Ch(e))),
		Nh = (e, t, n, o) => {
		...
		Rh = (e, t) => Z(e, (e) => En(e, t)),
		Ah = (e) =>
			Mt(Rh(e.cells, e.rng.start), Rh(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
		Oh = (e, t) => {
							...
							bs(o)
								...
								: ((e, t, n, o, r) =>
										gu(n, e.getBody(), r).bind((e) =>
											Uh(t, yn(e.getNode())).bind((e) => (En(e, o) ? I.none() : I.some(E)))
										))(e, n, t, o, r)
						);
					})(e, t, o, n).orThunk(() =>
						It(
						...
						return 0 !== n.length
							...
							: ((e, t, n, o) =>
									zh(t, o).fold(
										() =>
											((e, t, n) =>
												Th(t, n).bind((t) => t.fold(O(Ih, e), O(Fh, e), O(Lh, e), O(Mh, e))))(
												e,
												t,
												n
											),
		...
		Ab = (e) => {
			const t = bn('span');
			return (
				Zt(t, { id: wu, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
				e && bo(t, vn(_b)),
				t
			);
		},
	...
	const jb = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
		...
		qb = (e, t) =>
			!1 === bu(t, Li.fromRangeEnd(e)).exists((e) => !rr(e.getNode()) || bu(t, e).isSome()),
		...
		cv = (e, t, n) => {
			...
			wm(n) &&
				...
				(((e) => xm(e) && km(e) && Pt(xe(e, 'mixed'), !0))(n) && !rv(n.inline, t)) ||
					s.remove(t, !0);
		},
		...
		fv = (e, t, n, o, r) => {
			...
			ov(n.styles, (a, i) => {
				const { name: l, value: d } = uv(i, a, o),
					c = hm(d, l);
				(n.remove_similar || h(d) || !$o(r) || rv(bm(e, r, l), c)) && e.setStyle(t, l, ''),
					(s = !0);
			}),
				s && mv(e, t);
		},
		gv = (e, t, n, o, r) => {
			const s = e.dom,
				a = Gh(e),
				i = e.schema;
			if (km(t) && Ns(i, t.inline) && As(i, o) && o.parentElement === e.getBody())
					...
					ov(t.attributes, (e, o) => {
						...
						if (t.remove_similar || h(i) || !$o(r) || rv(s.getAttrib(r, a), i)) {
							...
							if (
								...
								'style' === a && Vo(['li'])(l) && 'none' === s.getStyle(l, 'list-style-type'))
							)
							...
							if (a.split) {
								if (((r = Bf(r)), (n = av(e, r, !0)), (o = av(e, r)), n !== o)) {
									if (((n = iv(n, !0)), (o = iv(o, !1)), sv(i, n, o))) {
										...
										return (
											d(dv(i, e, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
											void m(!0)
										);
									}
									if (sv(i, o, n)) {
										...
										return (
											d(dv(i, e, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
											void m(!1)
										);
									}
									(n = lv(i, n, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
										(o = lv(i, o, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
									const e = i.createRng();
									e.setStartAfter(n),
										e.setEndBefore(o),
										zm(i, e, (e) => {
						...
						const p = (a) => {
							...
							if (((o) => ((e) => wm(e) && !0 === e.wrapper)(s) && Eb(e, o, t, n))(a)) u = null;
								...
								if (
									((t, n, o) => {
										const r =
											((e) => wm(e) && !0 !== e.wrapper)(s) && cm(e.schema, t) && um(e, n, f);
										return o && r;
									})(a, w, k)
								) {
								  ...
								  (s.exact ||
										...
										(a = ((e) => {
											const t = J(e.childNodes, sm).filter(
												(e) => 'false' !== o.getContentEditable(e) && xb(o, e, s)
											);
											return t
												.map((t) => {
													const n = o.clone(t, !1);
								  ...
								  ((e, t, n, o, r) => {
										...
										(Eb(e, s, n, o) && bv(e, t, o, r)) ||
											(t.merge_with_parents &&
												s &&
												e.dom.getParent(s, (s) => !!Eb(e, s, n, o) && (bv(e, t, o, r), !0)));
								  })(e, s, t, n, a),
								  ((e, t, n, o) => {
										if (t.styles && t.styles.backgroundColor) {
											...
											Jb(
												o,
												(e) => r(e) && am(e),
												ev(e, 'backgroundColor', gm(t.styles.backgroundColor, n))
											);
										}
								  })(o, s, n, a),
								  ((e, t, n, o) => {
	...
	const Mv = (e, t, n) =>
		...
		Fv = (e, t, n = !1) =>
			Mv(t, n, (t, n) => I.from(e.getByData(t, n)).orThunk(() => Dv(n, t).map((n) => Iv(e, n, t)))),
		Uv = (e, t) => {
			const n = e.schema;
			...
			t.validate &&
				...
				((e, t) => {
					...
					if (n) {
						const t = (e) => {
							const t = e.attr('src');
							((e) => e.attr('src') === At.transparentSrc || C(e.attr('data-mce-placeholder')))(
								e
							) ||
				...
				Pe = function (e) {
					...
					return e instanceof l &&
						...
						? (X &&
								...
								(t = ly(t, P, ' ')),
								e.textContent !== t &&
									(sy(n.removed, { element: e.cloneNode() }), (e.textContent = t))),
				...
				Le = function (e, t, n) {
					...
					if (G && !W[t] && uy(L, t));
						...
						if (
							!(
								(Me(e) &&
									((q.tagNameCheck instanceof RegExp && uy(q.tagNameCheck, e)) ||
										(q.tagNameCheck instanceof Function && q.tagNameCheck(e))) &&
									((q.attributeNameCheck instanceof RegExp && uy(q.attributeNameCheck, t)) ||
										(q.attributeNameCheck instanceof Function && q.attributeNameCheck(t)))) ||
								('is' === t &&
									q.allowCustomizedBuiltInElements &&
									((q.tagNameCheck instanceof RegExp && uy(q.tagNameCheck, n)) ||
				...
				(n.sanitize = function (e, r) {
					...
					if ((J || xe(r), (n.removed = []), 'string' == typeof e && (se = !1), se)) {
						if (e.nodeName) {
							var m = B(e.nodeName);
							if (!z[m] || V[m])
								throw my('root node is forbidden and cannot be sanitized in-place');
						}
			...
			return (
				...
				(!!/((java|vb)script|mhtml):/i.test(o) ||
					(!e.allow_html_data_urls &&
						(/^data:image\//i.test(o)
							? ((e, t) => (C(e) ? !e : !C(t) || !H(Hy, t)))(e.allow_svg_data_urls, n) &&
	...
	const Gy = (e, t, n, o) => {
								...
								((e, n) => {
									...
									if (t.isValidChild(e.name, n.toLowerCase())) {
										for (; i; ) {
											...
											g(o, i)
												? (l ||
														((l = new Fg(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)),
												  l.append(i))
												: (d(l), (l = null)),
												(i = t);
										}
		...
		rC = (e, t, n) => {
			...
			if (gb(e)) {
				if (r.content !== o) {
					const t = oC({ validate: !1, forced_root_block: !1, sanitize: n }).parse(r.content, {
						context: e.name
					});
					return { ...r, content: t };
				}
		...
		TC = (e, t) =>
			!(!e || !t) && (!!((e, t) => AC(e) === AC(t))(e, t) || ((e, t) => OC(e) === OC(t))(e, t)),
		BC = (e) => 0 === e.get(),
		DC = (e, t, n) => {
			BC(n) && (e.typing = t);
		},
		...
		LC = (e) => ({
			...
			undoManager: {
				...
				hasUndo: (t, n) =>
					((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !TC(NC(e), t.data[0])))(e, t, n),
				hasRedo: (e, t) => ((e, t) => t.get() < e.data.length - 1 && !e.typing)(e, t),
				transact: (e, t, n) =>
					((e, t, n) => (PC(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
				ignore: (e, t) =>
					((e, t) => {
						try {
							e.set(e.get() + 1), t();
					...
					((e, t) => {
						...
						return I.from(e.selection.getStart(!0))
							.bind((o) =>
								vb(
									yn(o),
									(n) => ue(t, (t) => ((t, n) => (Eb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)),
									n
								)
							)
							.getOrNull();
			...
			editor: {
				getContent: (t) =>
					((e, t) =>
						I.from(e.getBody()).fold(N('tree' === t.format ? new Fg('body', 11) : ''), (n) =>
							Kg(e, t, n)
						))(e, t),
				setContent: (t, n) =>
					((e, t, n) =>
		...
		jC = (e, t, n, o) => {
			e.bind(
				...
				const e = ((e, t) => e.filter((e) => Wm.isBookmarkNode(e.dom)).bind(t ? Dn : Bn))(t, o)
					.or(t)
					.filter(Kt);
				return e.map((e) =>
					((e, t) => {
			...
			const { selectorChangedWithUnbind: a } = ((e, t) => {
				...
				c = () => {
					...
					try {
						...
						e &&
							!Ho(e.anchorNode) &&
							((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = Rg(o, [n])[0]));
					} catch (e) {}
				...
				f = {
					...
					getContent: (e) =>
						((e, t = {}) =>
							((e, t, n) => FC(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(
							o,
							e
						),
					setContent: i,
							...
							I.from(t).bind((t) =>
								I.from(t.parentNode).map((o) => {
									const r = e.nodeIndex(t),
										s = e.createRng();
									return (
										s.setStart(o, r), s.setEnd(o, r + 1), n && (em(e, s, t, !0), em(e, s, t, !1)), s
									);
								})
							))(e, t, n).each(u),
						t
		...
		hw = (e) => {
			const t = [],
				...
				a = (a, i = !0) =>
					e.removed ||
					!((e) => {
						return ((t = e.inline ? e.getBody() : e.getContentAreaContainer()), I.from(t).map(yn))
							.map(Yn)
							.getOr(!1);
						var t;
					})(e)
										...
										return C(s)
											...
											: ((o = t),
											  He(o, 'blob:')
													...
													Pv(t).then((o) => Mv(o, !1, (n) => I.some(Iv(e, t, n))).getOrThunk(n))
											  );
									}
									var o, r;
									return He(t, 'data:')
														...
														wo(n),
															o.each(
																((e) => (t) => {
																	((e, t) =>
																		e.dom.isEmpty(t.dom) &&
																		C(e.schema.getTextBlockElements()[Ht(t)]))(e, t) &&
		...
		$w = (e) => {
			...
			return (
					...
					})(n, e),
				{
					...
					match: (t, n, o, r) =>
						((e, t, n, o, r) => FC(e).formatter.match(t, n, o, r))(e, t, n, o, r),
					closest: (t) => ((e, t) => FC(e).formatter.closest(t))(e, t),
					matchAll: (t, n) => ((e, t, n) => FC(e).formatter.matchAll(t, n))(e, t, n),
					matchNode: (t, n, o, r) =>
						((e, t, n, o, r) => FC(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
					canApply: (t) => ((e, t) => FC(e).formatter.canApply(t))(e, t),
					formatChanged: (t, o, r, s) =>
						((e, t, n, o, r, s) => FC(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
					getCssText: O(Hw, e)
				}
			);
		},
		...
		Vw = (e) => {
			const t = za(),
				...
				r = {
					...
					add: (s, a) =>
						((e, t, n, o, r, s, a) => FC(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
					dispatchChange: () => {
						e.setDirty(!0);
						const t = NC(e);
						...
						e.on('init', () => {
							...
							e.on('keydown', (e) => {
								...
								if ((s < 16 || s > 20) && 224 !== s && 91 !== s && !t.typing && !a)
									return t.beforeChange(), DC(t, !0, n), t.add({}, e), void o.set(!0);
				...
				.fold(
					() =>
						((e, t, n) => {
										...
										((e, t) => {
											...
											? ((e, t) =>
													y(t)
														...
														: I.none())(t, n.getNode(!t)).orThunk(() => Cx(e, t, n))
											: Cx(e, t, n).bind((t) =>
													((e, t, n) =>
														n.fold(
							...
							(n) => () =>
								n.fold(
									((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), rh(e, t, yn(n)), !0))(
										e,
										t
									),
									((e, t) => (n) => {
			...
			e
				? ((e) => {
						...
						if (_x(e.previousSibling))
							return Rx(e.previousSibling) || e.previousSibling.appendData(Mr), e.previousSibling;
				...
				: ((e) => {
						var t, n;
						if (_x(e.nextSibling))
							return Nx(e.nextSibling) || e.nextSibling.insertData(0, Mr), e.nextSibling;
	...
	const nk = (e, t) => (e === Jc.Backwards ? oe(t) : t),
		...
		rk = (e, t, n, o) =>
			rr(o.getNode(t === Jc.Forwards)) ? tk.Br : !1 === Uc(n, o) ? tk.Block : tk.Wrap,
		sk = (e, t, n, o) => {
			const r = du(n);
			let s = o;
			const a = [];
			for (; s; ) {
				...
				if (rr(n.getNode(!1)))
					return t === Jc.Forwards
						? { positions: nk(t, a).concat([n]), breakType: tk.Br, breakAt: I.some(n) }
	...
	const Ek = (e, t, n, o, r, s) => {
		...
		jk = (e, t, n) =>
			...
			((e, t) => {
				...
				return (
					...
					(e && Vr(o) ? ek(!0, t.selection, o) : !(e || !Wr(o)) && ek(!1, t.selection, o))
				);
			})(e, t),
		Hk = (e) => {
			const t = Da(null),
		...
		hE = (e, t, n) =>
			ue([pE, Ex, hx, (e, n) => Gk(e, t, n), ax, qh, Sx, iE, dx, oE], (t) => t(e, n)).filter((t) =>
		...
		NE = (e, t) => {
			t.hasAttribute('data-mce-caret') &&
				(Yr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t));
		},
		RE = (e, t) => {
			const n = ((e) =>
		...
		jE = (e, t) =>
			J(
				((e, t) => te(((e) => q(e, (e) => ({ ...FE, ...e })))(e), (e) => (UE(e, t) ? [e] : [])))(
					e,
					t
				),
				(e) => e.action()
		...
		tS = (e, t, n) => {
			...
			return ((e) => e.breakType === tk.Wrap && 0 === e.positions.length)(o) ||
				(!rr(n.getNode()) && ((e) => e.breakType === tk.Br && 1 === e.positions.length)(o))
			...
			return ((e, t) =>
				((e, t, n = L) =>
					n(t)
						...
						: H(e, Ht(t))
						? I.some(t)
						: Zn(t, e.join(','), (e) => xn(e, 'table') || n(e)))(['td', 'th'], e, t))(
				yn(t ? s.endContainer : s.startContainer),
				r
			)
				.map(
					(n) => (
	...
	const AS = (e, t, n) => (e.stype === RS.Error ? t(e.serror) : n(e.svalue)),
							...
							xe(n, o).fold(
								() =>
									((e, t, n) =>
										PS(
											e,
											() => 'The chosen schema: "' + n + '" did not exist in branches: ' + DS(t)
										))(e, n, o),
					...
					e.fold(
						...
						(e) => {
							...
							return (
								(s = n),
								(a = I.some),
								s.stype === RS.Value ? { stype: RS.Value, svalue: a(s.svalue) } : s
							);
							var s, a;
						}
					);
				...
				case 'required':
					return ((e, t, n, o) =>
						xe(t, n).fold(
							() =>
								((e, t, n) =>
									PS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + DS(n)))(
									e,
									n,
									t
								),
		...
		KS = (e, t, n) => {
			return (
				(o = ((e, t, n) =>
					((e, t) => (e.stype === RS.Error ? { stype: RS.Error, serror: t(e.serror) } : e))(
						t.extract([e], n),
						(e) => ({ input: n, errors: e })
					))(e, t, n)),
				...
				((e) => {
					return (
						(t = (t) =>
							H(e, t)
								? sl.value(t)
								: sl.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
						jS((e) => t(e).fold(TS, OS))
					);
					var t;
				})(n)
	...
	VS(
		[
			...
			m_('initValue', N('')),
			C_,
			((e, t) => t_(e, e, { tag: 'required', process: {} }, WS(t)))('commands', P_),
			a_('launch', GS('type', { contextformbutton: B_, contextformtogglebutton: D_ }))
		].concat(A_)
	);
	const L_ = (e) => {
						...
						t
							...
							.getOrThunk(() =>
								((e, t) => {
									const n = t(),
										o = e.selection.getRng();
									return ((e, t, n) => ue(n.triggers, (n) => ES(e, t, n)))(e.dom, o, n).bind((n) =>
										NS(e, t, n)
									);
								})(e, s)
							))(a).fold(r, (s) => {
			...
			return 'selection' === o
				...
				? ((e, t) =>
						t.startSummary.exists((t) =>
							((e, t) =>
								Cu(t).exists(
									(n) => (rr(n.getNode()) && vu(t, n).exists((t) => t.isEqual(e))) || n.isEqual(e)
								))(e, t)
						))(s, t) ||
				  ((e, t, n) =>
						n.startDetails.exists((n) => bu(e, t).forall((e) => !n.contains(e.container()))))(
						a,
						s,
						t
				  )
				: ((e, t) =>
						t.startSummary.exists((t) => ((e, t) => yu(t).exists((t) => t.isEqual(e)))(e, t)))(
						s,
						t
				  ) ||
				  ((e, t) =>
			...
			insert: (e, t) => {
				...
				const i = e.dom,
					...
					v = (e) => {
						...
						let s;
						for (
							Jo(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next());
							(s = r.current());
				...
				if (p)
					...
					((e) => {
						...
						((e, t) => {
							t.normalize();
							const n = t.lastChild;
							(!n || ($o(n) && /^(left|right)$/gi.test(e.getStyle(n, 'float', !0)))) &&
								e.add(t, 'br');
						})(i, S),
						i.isEmpty(S) && oN(S),
						R.normalize(),
		...
		qN = (e, t, n) => {
			n && !e.get() ? t.on('NodeChange', HN, !0) : !n && e.get() && t.off('NodeChange', HN),
				e.set(n);
		},
		VN = (e, t) => {
			const n = t.container(),
			...
			return It(
				...
				() => {
					...
					e.selection.isCollapsed() || e.getDoc().execCommand('Delete'),
						((e, t) => (Fp(e, t) ? WN(t) : KN(t)))(t, Li.fromRangeStart(e.selection.getRng())).each(
							GN(e)
						);
				}
			);
									...
									((e, t, n) => {
										jE(
											[
												...
												...(J_
													? [
															{ keyCode: ef.BACKSPACE, altKey: !0, action: zE(sE, e) },
															{ keyCode: ef.DELETE, altKey: !0, action: zE(sE, e) },
															...(n ? [{ keyCode: Z_ ? 224 : 91, action: zE(sE, e) }] : [])
													  ]
													: [
	...
	const iR = ti('mode'),
		...
		FR = (e, t, n, o, r) => {
			...
			if (!s.cancelled) {
				...
				r
					? Y_(e, 'insertFromPaste', { dataTransfer: IR(t) }).isDefaultPrevented() ||
					  (n(), G_(e, 'insertFromPaste'))
					: n();
			}
		},
		UR = (e, t, n, o) => {
		...
		qR = (e, t, n) => {
			...
			if (Ud(e) && o) {
				...
				if (s.length > 0)
					return (
						t.preventDefault(),
						((r = s), Promise.all(q(r, (e) => Pv(e).then((t) => ({ file: e, uri: t }))))).then(
							(t) => {
		...
		WR = (e, t, n) => {
			((e, t, n) => {
				let o;
				e.on('keydown', (e) => {
					((e) => (ef.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(
						e
					) &&
						!e.isDefaultPrevented() &&
			...
			((e) => {
				...
				((e, t) => {
					e.addCommand('mceTogglePlainTextPaste', () => {
						((e, t) => {
							'text' === t.get() ? (t.set('html'), Zm(e, !1)) : (t.set('text'), Zm(e, !0)),
								e.focus();
						})(e, t);
					}),
		...
		dA = (e) => {
			const t = ((e, t) => {
				const n = Li.fromRangeStart(e).getNode(),
					o = ((e, t) => Jn(yn(e), (e) => ((e) => ar(e.dom))(e) || xr(e), aA(t)).getOr(yn(t)).dom)(
						n,
						t
					),
					r = lA(n, o, !1),
	...
	const uA = (e, t) => Math.abs(e.left - t),
		...
		pA = (e, t, n) => {
			const o = (e) =>
					ss(e.node) ? I.some(e) : $o(e.node) ? pA(ce(e.node.childNodes), t, n) : I.none(),
				r = (e, r) => {
		...
		hA = (e, t, n) =>
			((e, t, n) => {
				...
				.filter((e) => Ec(e.node))
				.map((e) =>
					((e, t) => ({ node: e.node, position: uA(e, t) < mA(e, t) ? cA.Before : cA.After }))(e, t)
				),
		bA = (e) => {
			var t, n;
		...
		yA = (e, t, n, o) => {
			const r = ((e, t) => {
				...
				return (
					'dragstart' === t ? (oR(n), cR(n)) : 'drop' === t ? (rR(n), uR(n)) : (sR(n), mR(n)), n
				);
			})(n, e);
			return v(o)
				? ((e, t, n) => {
		...
		MA = (e) => {
			...
			let i;
			const l = (e) =>
					e !== o && (PA(e) || cr(e)) && n.isChildOf(e, o) && n.isEditable(e.parentNode),
				d = (n, o, s, a = !0) =>
					...
					e.on('mousedown', (r) => {
						...
						PA(a)
							...
							: hA(o, r.clientX, r.clientY).each((n) => {
									var o;
									r.preventDefault(),
										(o = d(1, n.node, n.position === cA.Before, !1)) && t.setRng(o),
									...
									const t = (t) => {
											if (!t.isDefaultPrevented()) {
												...
												n &&
													...
													(t.preventDefault(),
													'drop' === t.type && ww(e, 'Dropped file type is not supported'));
											}
										},
										n = (n) => {
											hg(e, n.target) && t(n);
		...
		eO = (e, t, n, o) => {
			...
			return vS(i, l - n.pattern.end.length, t).bind((d) => {
					...
					return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
				{
					...
					return m.map((e) => {
						const t = ((e, t, n, o = !1) =>
							UA(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
							r,
							s,
							e,
							o
							...
							return ((e, t) => {
								...
								.map((e) =>
									Dt.trim(i).length === e.start.length
										? []
										: [{ pattern: e, range: UA(s, s.getRoot(), t, 0, t, 0, true) }]
								)
								.getOr([]);
						})(e, o, a);
					return (
							...
							const t = [',', '.', ';', ':', '!', '?'],
								...
								o = () => {
									return (
										(t = Xd(e)),
										(n = Qd(e)),
										{ inlinePatterns: ul(t), blockPatterns: cl(t), dynamicPatternsLookup: n }
									);
									var t, n;
								},
							...
							if (
								((e) => {
									if (Gw(e)) {
										...
										return (
											!Yw(e) &&
											(ef.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || H(Ww, t))
										);
									}
									return !1;
								})(t)
				...
				((e) => {
					...
					if (m(t)) {
						...
						(e.theme = n(e, vw.urls[t]) || {}),
							w(e.theme.init) &&
								e.theme.init(e, vw.urls[t] || e.documentBaseUrl.replace(/\/$/, ''));
					} else e.theme = {};
				})(e),
				((e) => {
					const t = id(e),
								...
								(r.onload = () => {
									...
									(e.iframeHTML = ((e) => {
										...
										return (
											Sl(e) &&
												(t +=
													'<meta http-equiv="Content-Security-Policy" content="' + Sl(e) + '" />'),
				...
				.bind((n) =>
					((e, t, n) =>
						vb(
							...
							(t) =>
								((t) =>
									uo(t, e).orThunk(() => (zO(t) ? xe(UO, e).bind((e) => tn(t, e)) : I.none())))(t),
							(e) => En(yn(t), e)
				...
				: oT(e) &&
				  ((e, t) => {
						if (((e) => 'click' === e.type)(t) && !ef.metaKeyPressed(t)) {
							const n = yn(t.target);
							((e, t) => to(t, 'a', (t) => En(t, yn(e.getBody()))).bind((e) => tn(e, 'href')))(
								e,
								n
							).each((n) => {
				...
				'focus' !== e &&
					...
					(n.removed ||
						(t
							...
							: n.initialized &&
							  n.delegates &&
							  (n.dom.unbind(mT(n, e), e, n.delegates[e]), delete n.delegates[e])));
			},
		...
		_T = (e) => {
			...
			xT(kT(e.toLowerCase(), '+'), (e) => {
				((e) => e in ST)(e)
					...
					: ((t.charCode = e.charCodeAt(0)), (t.keyCode = ET[e] || e.toUpperCase().charCodeAt(0)));
			});
			const o = [t.keyCode];
			let r;
	...
	class BT {
			...
			(this.options = ((e, t) => {
				const n = {},
					...
					r = (e, t, n) => {
						...
						return vT(r)
							? ((o[e] = r.value), !0)
							: (console.warn(bT(`Invalid value passed for the ${e} option`, r)), !1);
					},
					s = (e) => ke(n, e);
				return {
					register: (e, s) => {
			...
			((e) => {
				...
				e.on('remove', () => {
					...
					(e.ui.styleSheetLoader = ((e, t) =>
						Ms.forElement(e, { contentCssCors: Ed(t), referrerPolicy: ql(t) }))(o, e)),
					pd(e)
						? (e.inline = !0)
		...
		hide() {
			...
			e.hidden ||
				...
				e.inline
					...
					: (AT.hide(e.getContainer()), AT.setStyle(e.id, 'display', e.orgDisplay)),
				(e.hidden = !0),
				e.dispatch('hide'));
		}
		isHidden() {
		...
		resetContent(e) {
			void 0 === e ? GC(this, this.startContent, { format: 'raw' }) : GC(this, e),
		...
		getContainer() {
			const e = this;
			return (
				e.container || (e.container = e.editorContainer || AT.get(e.id + '_parent')), e.container
			);
		}
	...
	const FT = (e) => {
		...
		zT = (e) => {
			...
			return (
				(IT = G(IT, (t) => e !== t)),
				HT.activeEditor === e && (HT.activeEditor = IT.length > 0 ? IT[0] : null),
		...
		HT = {
					...
					DT.unbind(window, 'ready', s),
						...
						Dt.each(i, (e) => {
							...
							(n = t.get(e.id)) &&
								...
								(zT(n), n.unbindAllNativeEvents(), n.destroy(!0), (n.removed = !0));
						}),
						...
						return (
							...
							h(t.get(n.id))
								...
								: (zT(n) && t.dispatch('RemoveEditor', { editor: n }),
								  0 === IT.length && window.removeEventListener('beforeunload', LT),
								  n.remove(),
								  UT(IT.length > 0),
								  n)
						);
			...
			_setBaseUrl(e) {
				(this.baseURL = new qy(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
...
(function (cloudSettings) {
	...
	service_message:
		'This domain is not registered with Tiny Cloud.  Please see the \u003ca target="_blank" href="https://www.tiny.cloud/docs/tinymce/6/cloud-quick-start/"\u003equick start guide\u003c/a\u003e or \u003ca target="_blank" href="https://www.tiny.cloud/auth/signup/"\u003ecreate an account\u003c/a\u003e.'
});
tinymce.baseURL = 'https://cdn.tiny.cloud/1/no-api-key/tinymce/6.7.2-32';
	...
	function S(i, c) {
		return function (e) {
			var n = e.options,
				...
				r = c.legacyProcessor,
				o = c.defaultValue;
			return (a(n) ? (n.isSet(i) ? T.from(n.get(i)) : T.none()).bind(t) : r(e.getParam(i))).getOr(
				o
			);
		};
	}
	...
	var G,
				...
				te
					...
					.map(function (e) {
						for (var n = '', t = 0; t < 16; t++) {
							var r = e[t];
							(n += 6 === t ? D[(15 & r) | 64] : 8 === t ? D[(63 & r) | 128] : D[r]),
								(3 !== t && 5 !== t && 7 !== t && 9 !== t) || (n += '-');
						}
						return n;
					})
		...
		Ee = function (e) {
			if (a(e.value) && U(e.value, 'list-style-type'))
				return (e = e.value['list-style-type']), 'advlist_'.concat('' === e ? 'default' : e);
		},
		Ve = [
			'a11ychecker',
			'advcode',
